...
export function safeParseISO(dateString) {
  try {
...
export function isDateUnlocked(unlockDate) {
  try {
...
export function daysSinceDate(dateString) {
  try {
...
export function getModuleUnlockDate(courseStartDate, moduleIndex) {
  try {
